    ...
    def train_iteration(
        ...
        for _ in range(1, total_timesteps + 1):
            ...
            gpi_returns_test_tasks = [
                policy_evaluation_mo(self, eval_env, ew, rep=5)[3] for ew in eval_weights]
            ...
            print(f"mean_utility:{mean_gpi_returns_test_tasks}")
            self.mean_utility.append(mean_gpi_returns_test_tasks)
    ...
    def pre_train(self,
        ...
        for iter in range(1, max_iter + 1):
            ...
            if self.log:
                ...
                # print(f"gpi_returns_tasks:{gpi_returns_test_tasks}")
                log_all_multi_policy_metrics(
                ...
                # mean_utility.append(mean_gpi_returns_test_tasks)
                print(f"log Mean Utility:{mean_gpi_returns_test_tasks}\titer:{iter}")
            self.save(filename=f"GPI-PD {weight_selection_algo}", save_replay_buffer=False)

        self.close_wandb()
        np.save("mean_utility", self.mean_utility)
